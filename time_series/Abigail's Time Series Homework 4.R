...
x1.24.sin=sin(2*pi*index.ts*1/8766)
x1.24.cos=cos(2*pi*index.ts*1/8766)
x2.24.sin=sin(2*pi*index.ts*2/8766)
x2.24.cos=cos(2*pi*index.ts*2/8766)
x3.24.sin=sin(2*pi*index.ts*3/8766)
x3.24.cos=cos(2*pi*index.ts*3/8766)
x4.24.sin=sin(2*pi*index.ts*4/8766)
x4.24.cos=cos(2*pi*index.ts*4/8766)
x5.24.sin=sin(2*pi*index.ts*5/8766)
x5.24.cos=cos(2*pi*index.ts*5/8766)
